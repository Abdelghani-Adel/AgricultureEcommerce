    ...
    render() {
        ...
        return (
            <>
                                        ...
                                        <div className="andro_product andro_product-minimal andro_product-has-controls andro_product-has-buttons">
                                            ...
                                            <div className="andro_product-footer">
                                                ...
                                                <div className="andro_product-buttons">
                                                    <Link href={"/product-single/" + item.id} className="agri-btn-rounded primary">{this.props.t("Products.ReadMore")}</Link>
                ...
                <Link href="#" className="agri-btn-rounded-dark">{this.props.t("Products.ViewAll")}</Link>
            </>
