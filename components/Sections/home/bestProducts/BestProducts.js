                            ...
                            <div key={i} className="andro_product andro_product-has-controls andro_product-has-buttons">
                                ...
                                <div className="andro_product-footer">
                                    <div className="andro_product-buttons">
                                        <Link href={"/product-single/" + item.id} className="andro_btn-custom primary">{this.props.t("Products.AddToCart")}</Link>
                                        <Link href={"/products/" + item.slug} className="andro_btn-custom light" >{this.props.t("Products.ViewDetails")}</Link>
                                    </div>
                                </div>
                            </div>
                        ))
