...
const CookiesNotification = () => {
  ...
  return (
    <Fragment>
      {cookies === false && (
        <div className={`cookie-notification ${hidden ? "hidden" : ""}`}>
          <svg
            aria-hidden="true"
            width="96"
            height="96"
            viewBox="0 0 96 96"
            className="cookie-notification--image"
          >
            <path
          ...
          <h6 className="fw-bold txt-white mt-4 mb-2">Your privacy</h6>

          <p className="cookie-notification--paragraph">
            By clicking “Accept cookies”, you agree this website can store cookies on your device
