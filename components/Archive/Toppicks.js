              ...
              .map((item, i) => (
                <div key={i} className="col-lg-6">
                  {item.map((item, i) => (
                    <div
                      key={i}
                      className="andro_product andro_product-list andro_product-has-controls andro_product-has-buttons"
                    >
                      {item.featured === true ? (
                      ...
                      <div className="andro_product-footer">
                        <div className="andro_product-buttons">
                          ...
                          <Link to="#" className="andro_btn-custom light" onClick={this.modalShow}>
                            Quick View
                          </Link>
                        </div>
                      </div>
