...
import { FaShoppingBasket, FaRegHeart, FaRegEye, FaCompressAlt, FaSort, FaStar } from "react-icons/fa";
            ...
            <div className="andro_section-fw">
                <div className="row">
                    ...
                    <div className="andro_shop-global">
                        <p>Showing <b>{this.state.itemsPerPage}</b> of <b>{Items.length}</b> products </p>
                        <form method="post">
                            ...
                            <div key={i} className="col-md-4 col-sm-6 col-xs-12 masonry-item">
                                    <div className="andro_product andro_product-has-controls">
                                        ...
                                        <div className="andro_product-body">
                                            <h5 className="andro_product-title"><Link href={"/product-single/" + item.id}> {item.title} </Link> </h5>
                                            ...
                                            <div className="andro_rating-wrapper">
                                                ...
                                                <span>{item.rating}{this.props.t("Products.Stars")}</span>
                                            </div>
                                        </div>
                                        <div className="andro_product-footer">
                                            <div className="andro_product-controls">
                                                <Link href={"/product-single/" + item.id} data-toggle="tooltip" data-placement="top" title={this.props.t("Products.AddToCart")}>

                                                    <FaShoppingBasket />

                                                </Link>
                                                <Link href={"/products/"+`${item.slug}`} onClick={this.modalShow} data-toggle="tooltip" data-placement="top" title={this.props.t("Products.ViewDetails")}>

                                                    <FaRegEye />

                                                </Link>
                                                <Link href="#" data-toggle="tooltip" data-placement="top" title={this.props.t("Products.Compare")}>

                                                    <FaCompressAlt />

                                                </Link>
                                                <Link href="#" className="favorite" data-toggle="tooltip" data-placement="top" title={this.props.t("Products.AddToWish")}>
                ...
                <div className="col-lg-3 col-xs-12">
                            <div className="sidebar">
                                ...
                                <div className="sidebar-widget">
                                    ...
                                    <IonRangeSlider type="double" min={0} max={500} from={10} to={100} grid={true} postfix=" $" onChange={this.handlePriceChange}/>
                                </div>
                                {/* Filter: Price End */}
