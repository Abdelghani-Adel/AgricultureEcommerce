                        ...
                        <div className="row">
                            <div className="col-xl-3 col-lg-3 col-md-4 col-sm-12 footer-widget">
                                ...
                                <ul>
                                    ...
                                    <li> <Link href="/shop-v1">Shop</Link> </li>
                            ...
                            <div className="col-xl-3 col-lg-3 col-md-4 col-sm-12 footer-widget">
                                ...
                                <ul>
                                    ...
                                    <li> <Link href="/product-single">Product</Link> </li>
                                    <li> <Link href="/shop-v1">Shop</Link> </li>
                            ...
                            <div className="col-xl-3 col-lg-3 col-md-6 col-sm-12 footer-widget">
                                ...
                                <ul className="social-media">
                                    <li> <Link href="#" className="facebook"> <FaFacebookF/> </Link> </li>
                                   
                                    <li> <Link href="#" className="google"> <FaYoutube /> </Link> </li>
                                    <li> <Link href="#" className="twitter"> <FaTwitter/> </Link> </li>
                                </ul>
                                <div className="andro_footer-offer">
                                    <p>{this.props.t("Footer.Signup")}</p>
                                    <Link href="/register" className="andro_btn-custom btn-sm shadow-none">{this.props.t("Footer.Signup")}</Link>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="andro_footer-bottom">
                    <div className="container">
                        ...
                        <div className="andro_footer-copyright">
                            <p> Copyright © 2023 <Link href="#">RTS</Link> All Rights Reserved. </p>
                            <Link href="#" className="andro_back-to-top" onClick={() => this.scrollToTop()}>Back to top <span><FaChevronUp/></span> </Link>
                        </div>
                    </div>
                </div>
            </footer>
